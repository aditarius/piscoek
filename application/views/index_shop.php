...
<?php } ?>
      ...
      <section class="home-section home-fade home-full-height" id="home">
        <div class="hero-slider">
          <ul class="slides">
            <li class="bg-dark-30 bg-dark shop-page-header" style="background-image:url(&quot;<?php echo base_url();?>assets/images/shop/sider1.jpg&quot;);">
              <div class="titan-caption">
                <div class="caption-content">
                  <div class="font-alt mb-30 titan-title-size-1">Selamat Datang </div>
                  <div class="font-alt mb-30 titan-title-size-4"> di Piscoek</div>
                  <div class="font-alt mb-40 titan-title-size-1">Selamat Berbelanja</div>
                </div>
              </div>
            </li>
            <li class="bg-dark-30 bg-dark shop-page-header" style="background-image:url(&quot;<?php echo base_url();?>assets/images/shop/sider2.jpg&quot;);">
              <div class="titan-caption">
                <div class="caption-content">

                  <div class="font-alt mb-40 titan-title-size-3">pisang cokelat dengan kualitas terbaik</div>
                </div>
              </div>
            </li>
            <li class="bg-dark-30 bg-dark shop-page-header" style="background-image:url(&quot;<?php echo base_url();?>assets/images/shop/sider3.jpg&quot;);">
              <div class="titan-caption">
                <div class="caption-content">
                  <div class="font-alt mb-30 titan-title-size-4">Cocok untuk Cemilan di rumah</div>
        ...
        <div class="container">
            <div class="row">
              <div class="col-sm-6 col-sm-offset-3">
                <h2 class="module-title font-alt">Latest Product</h2>
              </div>
            </div>
          <div class="row">
    <!-- looping products -->
      <?php foreach($products as $product) : ?>
       <div class="col-sm-6 col-md-3 col-lg-3">
        ...
        'style'   => 'max-width: 100%; max-height:100%; height:300px'
                    ...
                    <div class="shop-item-detail"><?=anchor('welcome/add_to_cart/' . $product->id, 'Add To Cart' , [
            'class' => 'btn btn-round btn-b ',
            'role'  => 'button'
          ])?></div>
                  </div>
                  <h4 class="shop-item-title font-alt"><a href="#"><?=$product->name?></a></h4>Rp. <?=$product->price?>
      ...
      <?php endforeach; ?>
         ...
         <section class="module module-video bg-dark-30" data-background="">
          <div class="container">
            <div class="row">
              <div class="col-sm-6 col-sm-offset-3">
                <h2 class="module-title font-alt mb-0">Enjoy your Piscoek. Spread The Love.</h2>
              </div>
            </div>
          </div>
          <div class="video-player" data-property="{videoURL:'https://www.youtube.com/watch?v=a87GC4ahmjA', containment:'.module-video', startAt:0, mute:true, autoPlay:true, loop:true, opacity:1, showControls:false, showYTLogo:false, vol:25}"></div>
        </section>
        <hr class="divider-w">
