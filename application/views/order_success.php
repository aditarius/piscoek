...
<?php } ?>
    ...
    <div class="main">
        <section class="module bg-dark-30" data-background="<?php echo base_url();?>assets/images/shop/sider3.jpg">
          <div class="container">
            <div class="row">
              <div class="col-sm-6 col-sm-offset-3">
                <h1 class="module-title font-alt mb-0">Terima Kasih Telah Melakukan Pemesanan, Kami Akan Mengirim Pesan Konfirmasi Melalui Email dalam 24 jam</h1>
              </div>
            </div>
          </div>
        </section>
